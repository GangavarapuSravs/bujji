...
// import Employee from '../db/models/task';
...
// // Get all employees
// employeeRouter.get('/empg', async (req: Request, res: Response) => {
//     try {
...
// // Add a new employee
// employeeRouter.post('/emppo', async (req: Request, res: Response) => {
...
// employeeRouter.put('/empp/:Id', async (req: Request, res: Response) => {
//     const { Id } = req.params;
//     const { name, email, department } = req.body;
...
// // Delete an employee
// employeeRouter.delete('/empd/:Id', async (req: Request, res: Response) => {              
//     const { Id } = req.params;
